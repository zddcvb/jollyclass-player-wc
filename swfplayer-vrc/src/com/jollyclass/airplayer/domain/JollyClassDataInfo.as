	...
	public class JollyClassDataInfo
	{
		...
		public function toString():String
		{
			return "JollyClassDataInfo[swfPath:"+_swfPath+",product_type:"+_product_type+",resource_type:"+_resource_type+",customer_service_tel"+_customer_service_tel+
				",teaching_status:"+_teaching_status+",teaching_resource_id:"+_teaching_resource_id+"package_name:"+_package_name+",family_media_id:"+_family_media_id+",family_material_id:"+_family_material_id+"]";
		}
